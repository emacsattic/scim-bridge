...
(defconst scim-bridge-zh-tr-version "0.8.1.12")
...
(scim-set-variable-doc
 ...
 "不要設置這個變量, 除非你想明確的指定 X Window 的顯示數和屏幕數.
設置這個變量會導致 scim 模式無法在多顯示器環境中使用.

如果你要設置這個變量, 值必須是字符串, 比如 \":0.0\".")
...
(scim-set-variable-doc
 ...
 "指定繼承輸入法的函數列表.
如果函數接受 INHERIT-INPUT-METHOD 參數, 輸入法隻有當它是非空時才繼承.
否則, 輸入法無條件繼承.")
